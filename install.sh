...
deploy_file "${FULL_SCRIPT_DIR}/dotfiles/dot_zshrc" ~/.zshrc
# $ZSH_CUSTOM = .oh-my-zsh
deploy_file "${FULL_SCRIPT_DIR}/dotfiles/dot_oh-my-zsh/themes/citelao.zsh-theme" ~/.oh-my-zsh/themes/citelao.zsh-theme
